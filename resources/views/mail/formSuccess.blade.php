...
<section style="padding:20px; line-height:0 ">
    <h3 style="font-size:1.25rem; top:20px; margin-bottom:20px;">Formularío Recibido</h3>
        <div style="width:100%; margin: auto">
            <div  style="font-weight: bold;  padding: 8px;">Formulario No:</div>
            <div  style="font-weight: normal;  padding: 8px;">{{isset($form_number)? $form_number:false}}</div>
