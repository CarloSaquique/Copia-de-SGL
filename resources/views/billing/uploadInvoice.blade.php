                    ...
                    <div id="upload_invoice_tip_1" class="hidden">
                        <p class="text-blue-800 ">
                            ...
                            <ul class="list-disc text-blue-800">
                                <li>Verifica el número de tracking del envío</li>
                                <li>Verifica la descripcion del articulo según su número de tracking</li>
                                <li>Carga únicamente el valor correspondiente del paquete no el total de tú compra.</li>
                            </ul>
                        </p>
                    </div>
                </div>
                ...
                <div class="my-2">
                    ...
                    <div class="hidden">
                        <p class="text-blue-800 ">
                            ...
                            paquete llegue a nuestro Centro de distribución de Miami o México para
                ...
                <div class="my-2">
                    ...
                    <div class="hidden">
                        <p class="text-blue-800 ">
                            ...
                            *Si tu paquete viene de México, debes declarar el valor
            ...
            <div class="w-11/12 mx-auto p-5 my-10 rounded-md border sm:w-10/12 xl:w-1/2 2xl:w-5/12">
                ...
                <form id="upload_invoice_form" action="/upload-invoice" method="post" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="my-2">
                        ...
                        <input name="order_number" class="bg-gray-300 rounded-3xl ring-0 border-none w-full lg:w-1/2 focus:ring-0" {{isset($order)? "readonly":false}}  type="text" value="{{isset($order)? $order->order_number:false}}">
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-5 text-center sm:grid-cols-2 md:grid-cols-3">
                        <div>
                            ...
                            <input name="value" class="bg-gray-300 rounded-3xl ring-0 border-none w-full focus:ring-0" {{isset($value)? "readonly":false}} type="text" value="{{isset($value)? $value:false}}">
                        </div>

                        <div>
                            <h3 class="text-blue-800 font-bold">Tracking de compra</h3>
                            <input name="tracking" class="bg-gray-300 rounded-3xl ring-0 border-none w-full focus:ring-0" type="text">
                        </div>

                        <div>
                            <h3 class="text-blue-800 font-bold">Codigo/Palabra Clave</h3>
                            <input name="keyword" class="bg-gray-300 rounded-3xl ring-0 border-none w-full focus:ring-0" type="text">
                        </div>
                    </div>
...
@push('child-scripts')
    <script>
        ...
        $('#upload_invoice_btn').click(function(){
            let fields = [
                {'name':'total','validation':['blank']},
                {'name':'tracking','validation':['blank']},
                {'name':'keyword','validation':['blank']},
                {'name':'new','validation':['isSelect']},
                {'name':'insurance','validation':['isSelect']},
                {'name':'divided','validation':['isSelect']},
