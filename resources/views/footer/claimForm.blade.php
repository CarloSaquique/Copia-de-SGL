...
@section('content')
    @if(!Session::has('form_success'))
        <section class="m-10 p-5 mx-auto w-2/3 bg-white rounded-lg shadow-lg">
        {{-- <div class="relative">
            <video class="w-full h-80 opacity-50" autoplay controls>
                <source src="{{asset('images/footer/video.mp4')}}" type="video/mp4">
                Your browser does not support the video tag.
            </video>
            <h3 class="absolute top-10 right-60 text-white text-6xl text-center mt-10 font-bold">Formulario <br>de Reclamo</h3>
        </div> --}}
        ...
        <form id="claim_form_form" action="/claim-form" method="POST" autocomplete="off" enctype="multipart/form-data" >
            ...
            <div class="w-full mx-auto p-10 border-b-2 rounded-lg flex justify-evenly">
                <div class="space-y-5">
                    <div>
                        ...
                        <input name="name" class="w-full rounded-lg" type="text" value="">
                    </div>
            ...
            <div class="border-b text-3xl text-center p-10">
            ...
            <div class="border-b text-center p-10">
