...
<section class="text-center  bg-white">
    ...
    <div class="bg-white py-10 text-justify my-5 px-5 items-center space-y-2 lg:flex sm:px-16 md:px-32 lg:px-16 xl:px-52 2xl:px-[450px]">
        ...
        <div class="lg:w-1/2 space-y-5">
            <h3 class="font-bold text-2xl">Holding</h3>
            <p class="text-lg">
    ...
    <div class="bg-white py-10 text-justify space-x-10 my-5 px-5 lg:flex sm:px-16 md:px-32 lg:px-16 xl:px-52 2xl:px-[450px]">
        <div class="lg:w-1/2 space-y-5">
            <h3 class="font-bold text-2xl">Centro De Operaciones</h3>
            <p class="text-lg">
        ...
        <div class="lg:w-1/2 space-y-5">
            <h3 class="font-bold text-2xl">Colaboradores</h3>
            <p class="text-lg">
    ...
    <div class="bg-white py-10 text-justify my-10 px-5 items-center space-y-2 lg:flex sm:px-16 md:px-32 lg:px-16 xl:px-52 2xl:px-[450px]">
        {{-- <div class="lg:w-1/2">
            <img class="rounded-lg mx-auto md:w-4/6 lg:w-5/6" src="{{asset('images/footer/modalidad_de_trabajo.jpg')}}">
        </div> --}}
        <div class="lg:w-1/2 space-y-5">
    ...
    <h3 class="font-bold text-2xl ">Sucursales</h3>
        ...
        <div class="hidden relative lg:block my-10 w-10/12 mx-auto">
            ...
            <div>
                ...
                <div id="about_us_map_info_el_salvador" class="hidden absolute top-[57%] left-[21%]
                    p-10 rounded-xl border-2 w-96 bg-white text-justify">
                    <div class="flex items-center mx-auto space-x-2">
            ...
            <div>
                ...
                <div id="about_us_map_info_usa" class="hidden absolute top-[40%] left-[20%]
                    p-10 rounded-xl border-2 w-96 bg-white text-justify">
                    <div class="flex items-center mx-auto space-x-2">
            ...
            <div>
                ...
                <div id="about_us_map_info_alemania" class="hidden absolute top-[32%] left-[48%]
                    p-10 rounded-xl border-2 w-96 bg-white text-justify">
                    <div class="flex items-center mx-auto space-x-2">
            ...
            <div>
                ...
                <div id="about_us_map_info_chile" class="hidden absolute top-[80%] left-[20%]
                    p-10 rounded-xl border-2 w-96 bg-white text-justify">
                    <div class="flex items-center mx-auto space-x-2">
            ...
            <div>
                ...
                <div id="about_us_map_info_espana" class="hidden absolute top-[40%] left-[20%]
                    p-10 rounded-xl border-2 w-96 bg-white text-justify">
                    <div class="flex items-center mx-auto space-x-2">
            ...
            <div>
                ...
                <div id="about_us_map_info_honduras" class="hidden absolute top-[40%] left-[20%]
                    p-10 rounded-xl border-2 w-96 bg-white text-justify">
                    <div class="flex items-center mx-auto space-x-2">
            ...
            <div>
                ...
                <div id="about_us_map_info_mexico" class="hidden absolute top-[40%] left-[20%]
                    p-10 rounded-xl border-2 w-96 bg-white text-justify">
                    <div class="flex items-center mx-auto space-x-2">
            ...
            <div>
                ...
                <div id="about_us_map_info_panama" class="hidden absolute top-[58%] left-[25%]
                    p-10 rounded-xl border-2 w-96 bg-white text-justify">
                    <div class="flex items-center mx-auto space-x-2">
        ...
        <div class="space-y-5 w-fit mx-auto lg:hidden">
            ...
            <div class="flex items-center space-x-1">
                ...
                <span>mexico-customerservice@gruposgl.com</span>
            </div><div class="flex items-center space-x-1">
                <img class="h-6" src="{{asset('images/flags/alemania.svg')}}" alt="">
                <span class="font-bold">Alemania:</span>
                <span>alemania-customerservice@gruposgl.com</span>
            </div><div class="flex items-center space-x-1">
