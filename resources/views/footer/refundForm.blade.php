...
<section class="m-10 p-5 bg-white rounded-xl">
    <form id="refund_form_form" action="/refund-form" method="POST" autocomplete="off" enctype="multipart/form-data" >
        ...
        <div class="w-full mx-auto p-10 border-b-2 rounded-lg flex justify-evenly">
                <div class="">
                    <h3 class="">Numero de Pedido OSC</h3>
                    <input name="osc_number" class="w-full rounded-lg" type="text" value="4321">
                </div>
                <div class="">
                    <h3 class="">Describa El Tipo De Servicio:</h3>
                ...
                <div class="">
                    <h3 class="">Describa el nombre de su asesor de ventas</h3>
        ...
        <div class="w-full mx-auto p-10 border-b-2 rounded-lg flex justify-evenly">
            <div class="">
                ...
                <div id="refund_form_all_include_div" class="border rounded-lg">
                    <div class="flex p-1 space-x-1">
                        <input name="purchase_date_1" class="rounded-lg p-2.5" type="date">
                        <select name="payment_type_1" class="w-full rounded-lg p-2.5 text-sm">
                            <option value="0">Seleccione Una Opción</option>
        ...
        <div class="w-full mx-auto p-10 border-b-2 rounded-lg flex justify-evenly">
            <div class="border-b">
                ...
                <textarea name="claim_description" id="" cols="100" rows="5"></textarea>
            </div>
        </div>
        ...
        <div class="py-10 ml-auto w-fit">
            <a class="underline" href="/refund-politics" target="_blank">Terminos y Condiciones</a>
            <br>
            <button id="refund_form_submit_btn" disabled type="button" class="bg-[rgb(0,100,255)]/100 text-white ml-auto block px-3 py-2 rounded-xl text-lg">Enviar</button>
        </div>
    </form>
</section>
...
<script>
    ...
    $('#refund_form_all_include_btn').click(function(){
        ...
        let html =
                '<div class="flex p-1 space-x-1">'+
                    '<input name="purchase_date_'+n+'" class="rounded-lg p-2.5" type="date">'+
                    '<select name="payment_type_'+n+'" class="w-full rounded-lg p-2.5 text-sm">'+
                        '<option value="0">Seleccione Una Opción</option>'+
                        '<option value="1">tarjeta de credito/debito</option>'+
                        '<option value="2" selected>efectivo</option>'+
                        '<option value="3">transferencia bancaria</option>'+
